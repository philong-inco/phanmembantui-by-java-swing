...
public class ConfirmDoiHang extends javax.swing.JFrame {
    ...
    public ConfirmDoiHang(ProductDetailResponse productDetailResponse, Long idHoaDon, DoiHangChiTiet chiTiet, Boolean doiHang) {
        initComponents();
    ...
    private void btnXacNhanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXacNhanActionPerformed
        ...
        chiTiet.showTable(chiTiet.getDetailService().findProductsById(idHoaDon, chiTiet.getTxtSearch().getText(),
                (String) chiTiet.getCbxMauSac().getSelectedItem(), (String) chiTiet.getCbxTheLoai().getSelectedItem()));
